...
import emptySearchImage from '../assets/images/search.png'; // Đặt đường dẫn đúng tới hình ảnh của bạn
...
const SearchScreen = () => {
  ...
  const data = [
    ...
    },
    {
        ...
        place: "Hà Nội",
        placeImage:
          "https://vov2.vov.vn/sites/default/files/styles/large/public/2022-03/doc-dao-le-hoi-van-hoa-du-lich-ha-noi-20201593134202.jpg",
        shortDescription: "City in Việt Nam, Việt Nam",
        properties: [
          {
            id: "30",
            name: "JW Marriott",
            image:
              "https://www.google.com/imgres?imgurl=https%3A%2F%2Fbitexco.com.vn%2Fwp-content%2Fuploads%2F2019%2F01%2FJW-3.jpg&tbnid=30Tavin6eu5X7M&vet=12ahUKEwiwisyZkZWCAxXg1zQHHbm1AdkQMygDegQIARBM..i&imgrefurl=https%3A%2F%2Fbitexco.com.vn%2Fdu-an%2Fkhach-san-jw-marriott-ha-noi%2F&docid=lVymtjAj0KLSaM&w=1200&h=800&q=JW%20Marriott&ved=2ahUKEwiwisyZkZWCAxXg1zQHHbm1AdkQMygDegQIARBM",
            rating: 3.6,
            address:
...
const styles = StyleSheet.create({
  backgroundImage: {
    flex: 1,
    resizeMode: "cover", // Chọn kiểu cover để ảnh nền che kín màn hình
